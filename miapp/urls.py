...
urlpatterns = [
    ...
    path('perfil/mis-datos/', views.mis_datos_view, name='mis_datos'),
    path('perfil/autenticacion/', views.autenticacion_view, name='autenticacion'),
    path('perfil/cambiar-contrasena/', views.cambiar_contrasena_view, name='cambiar_contrasena'),
    path('perfil/sesiones/', views.sesiones_view, name='sesiones'),
    path('perfil/direcciones/', views.direcciones_view, name='direcciones'),
